...
export function Search({ iconp, icon2, txt, placeholder }: search) {
    return (
        ...
        <div className="relative font-[Quicksand] font-semibold text-sm"><input type="text"
            placeholder={placeholder} className=" border borer-2 border-neutral-100 h-8 w-90 rounded-sm pl-10 text-[#767476] bg-[#F5F5F5] outline-none focus:ring-1 focus:ring-neutral-300" />
            {iconp}
